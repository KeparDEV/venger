// ==UserScript==
// @name         Kepar Loader and Kick Bypass
// @supportURL   https://kepar.cf/
// @homepage     https://kepar.cf/
...
let downloadScript = function(url) {
    ...
    xhr.send();
    if (xhr.status != 200) {
        alert("Error Downloading Kepar Loader");
        return null;
    }
...
let script = downloadScript("https://raw.githubusercontent.com/KeparDEV/venger/main/loader.js");
